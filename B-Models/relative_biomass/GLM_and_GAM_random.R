...
# Frequentist ---------------------------
## GLM ---------------------------
modelo_f_r <- glm(bio_relativa ~ batimetria + batimetria_2 + tiempo,
...
## GAM ---------------------------
modelo_fgam_r <- gam(bio_relativa ~ s(batimetria) + te(xcoord, ycoord) + tiempo,
                     data = data_random_final,
                     family = Gamma(link = "log")
                     )
...
# Save models ---------------------------
save.image("./B-Modelos/relative_biomass/GLM_GAM_random.RData") 
